...
class EnergyConsistencyStatusSensor(EnergyConsistencyBaseSensor):
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        return {
            ...
            "local_source_name": data.local_source_name,
            "local_source_role": data.local_source_role,
            "local_selection_reason": data.local_selection_reason,
            "fallback_used": data.fallback_used,
            "fallback_reason": data.fallback_reason,
            "primary_local_kwh": data.primary_local_kwh,
            "backup_local_kwh": data.backup_local_kwh,
            "primary_local_name": data.primary_local_name,
            "backup_local_name": data.backup_local_name,
            "primary_local_enabled": data.primary_local_enabled,
            "backup_local_enabled": data.backup_local_enabled,
            "primary_calibration_factor": data.primary_calibration_factor,
            "backup_calibration_factor": data.backup_calibration_factor,
            "primary_adjusted_kwh": data.primary_adjusted_kwh,
            "backup_adjusted_kwh": data.backup_adjusted_kwh,
            "local_sources_disagree": data.local_sources_disagree,
            "local_sources_difference_kwh": data.local_sources_difference_kwh,
            "local_sources_difference_percent": (data.local_sources_difference_percent),
            "recent_comparisons": [
                {
                    "date": record.date,
                    ...
                    "local_source_name": record.local_source_name,
                    "local_source_role": record.local_source_role,
                    "local_selection_reason": record.local_selection_reason,
                    "fallback_used": record.fallback_used,
                    "fallback_reason": record.fallback_reason,
                    "primary_local_kwh": record.primary_local_kwh,
                    "backup_local_kwh": record.backup_local_kwh,
                    "primary_local_name": record.primary_local_name,
                    "backup_local_name": record.backup_local_name,
                    "primary_local_enabled": record.primary_local_enabled,
                    "backup_local_enabled": record.backup_local_enabled,
                    "primary_calibration_factor": (record.primary_calibration_factor),
                    "backup_calibration_factor": record.backup_calibration_factor,
                    "primary_adjusted_kwh": record.primary_adjusted_kwh,
                    "backup_adjusted_kwh": record.backup_adjusted_kwh,
                    "local_sources_disagree": record.local_sources_disagree,
                    "local_sources_difference_kwh": (
